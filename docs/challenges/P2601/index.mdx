...
本题要求参赛者将 [KleidiCV](https://github.com/rv2036/rvspoc-P2601-kleidicv/tree/26.03 "KleidiCV 26.03") 核心功能**移植至 RISC-V 平台**，并利用 **RVV 1.0** 向量指令进行性能加速，探索 RISC-V 在计算机视觉领域的工程潜力。
...
- 与 [OpenCV](https://github.com/opencv/opencv/tree/4.13.0 "OpenCV 4.13.0") RISC-V 实现进行对比基准测试，并提供完整 kleidicv-benchmark 数据
...
| 赛题演示 | https://github.com/rv2036/rvspoc/blob/main/docs/guides/P2601/README.md |
